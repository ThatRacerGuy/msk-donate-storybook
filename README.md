<h1 align="center">
  MSK Giving Storybook (React-based)
</h1>
...
1.  **Open the source code and start editing!**
    ...
    Open the `msk-donate-storybook` directory in your code editor of choice.
...
2.  **`node_modules`**: This directory contains all of the modules of code that your project depends on (npm packages). This directory is not committed to the repo.
